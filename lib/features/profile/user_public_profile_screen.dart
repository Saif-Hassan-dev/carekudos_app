...
/// Screen to display another user's public profile by their UID.
class UserPublicProfileScreen extends StatelessWidget {
          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _buildStarHistorySection(profile),
                const SizedBox(height: 12),
                // Posts Section
                _buildPostsSection(profile),
      ...
      child: Column(
        children: [
          ...
          CircleAvatar(
            ...
            backgroundImage:
                profile.hasProfilePhoto && profile.profilePhotoBytes != null
  ...
  Widget _buildStarHistorySection(UserProfile profile) {
    return Container(
      color: Colors.white,
              ...
              return Column(
                children: stars.map((doc) {
                  ...
                  return _buildStarHistoryItem(
                    giverName: data['giverName'] ?? 'Someone',
                    starType: data['starType'] ?? 'Peer',
  ...
  Widget _buildPostsSection(UserProfile profile) {
    return Container(
      color: Colors.white,
      padding: const EdgeInsets.all(24),
      child: Column(
